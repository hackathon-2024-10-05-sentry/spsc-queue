...
pub fn build(b: *std.Build) void {
    ...
    // Add a static library instead of an executable
    const spscqueue_lib = b.addStaticLibrary(.{
        .name = "spscqueue",
    ...
    // Optional: Specify the output directory for the library
    // spscqueue_lib.setOutputDir(b.path("lib"));

    // Install the library so it can be used by other projects
    b.installArtifact(spscqueue_lib);
}
